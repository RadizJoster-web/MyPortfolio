...
export default function Header() {
  return (
    <header className="lg:col-span-7 space-y-4">
      <div className="space-y-4 text-center lg:text-start">
        ...
        <motion.h1
          ...
          className="text-3xl md:text-7xl font-black text-color-dark mb-6 leading-[1.1] tracking-tight"
        >
      ...
      <motion.p
        ...
        className="text-lg lg:text-xl text-color-dark lg:max-w-2xl text-center lg:text-start leading-relaxed"
      >
